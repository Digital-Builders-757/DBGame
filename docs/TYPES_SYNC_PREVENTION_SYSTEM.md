...
// To regenerate: npx -y supabase@2.34.3 gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public > types/database.ts
```
...
{
  "scripts": {
    "types:regen": "npx -y supabase@2.34.3 gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public > types/database.ts",
    "types:regen:dev": "npx -y supabase@2.34.3 gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public > types/database.ts",
    ...
    "link:dev": "npx -y supabase@2.34.3 link --project-ref hzcpxidgmvsfmmocnasj",

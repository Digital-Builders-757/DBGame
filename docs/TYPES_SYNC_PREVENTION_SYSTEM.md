...
// Generated from Supabase schema using: npx supabase gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public
...
// To regenerate: npx -y supabase@2.67.1 gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public > types/supabase.ts
```
...
{
  "scripts": {
    "types:regen": "npx -y supabase@2.67.1 gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public > types/supabase.ts",
    "types:regen:dev": "npx -y supabase@2.67.1 gen types typescript --project-id hzcpxidgmvsfmmocnasj --schema public > types/supabase.ts",
    "types:regen:prod": "if not defined SUPABASE_PROJECT_ID (echo SUPABASE_PROJECT_ID env var is required for prod regen && exit /b 1) else cmd /d /c \"set SUPABASE_INTERNAL_NO_DOTENV=1&& npx -y supabase@2.67.1 gen types typescript --project-id %SUPABASE_PROJECT_ID% --schema public > types\\supabase.ts\"",
    "link:dev": "npx -y supabase@2.67.1 link --project-ref hzcpxidgmvsfmmocnasj",
    "link:prod": "if not defined SUPABASE_PROJECT_ID (echo SUPABASE_PROJECT_ID env var is required for prod linking && exit /b 1) else npx -y supabase@2.67.1 link --project-id %SUPABASE_PROJECT_ID%",
...
```yaml
env:
  SUPABASE_PROJECT_REF_DEV: hzcpxidgmvsfmmocnasj
  ...
  verify-schema:
    steps:
      ...
      - name: Generate types from remote schema (branch-aware)
        run: npx -y supabase@2.67.1 gen types typescript --project-id ${{ steps.ref.outputs.ref }} --schema public > types/temp_schema_types.ts
```
- ✅ **Branch-aware project selection**: `main` → prod, `develop` → dev
- ✅ **Consistent CLI version**: Always uses `2.67.1`
...
- **`develop` branch** → Uses development project (`hzcpxidgmvsfmmocnasj`)

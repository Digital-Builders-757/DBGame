...
export default async function SuspendedPage() {
  ...
  return (
    <div className="relative min-h-screen bg-brand-background flex flex-col items-center justify-center px-4 text-center overflow-hidden">
      ...
      <div className="max-w-xl w-full space-y-6 relative z-10 bg-brand-card/80 border border-brand-border rounded-2xl p-8 shadow-2xl shadow-brand-blue/20 backdrop-blur">
        <div className="space-y-3">
          <p className="text-sm font-semibold text-brand-blue uppercase tracking-wide">Account Hold</p>
          ...
          <p className="text-base text-brand-text-secondary">
            ...
            Please review the details below and contact the ViBE team if you believe this is a mistake.
          </p>
        </div>
        ...
        {suspensionReason ? (
          ...
          <div className="rounded-2xl border border-brand-border bg-brand-background p-5 text-left shadow-inner">
            <p className="text-brand-text-primary">
              A ViBE moderator has suspended this account. Reach out to confirm the next steps.
            </p>
          </div>
        )}
        ...
        <div className="space-y-3 text-sm text-brand-text-secondary">
          <p>
            ✅ If you&apos;re a user, contact support for next steps or appeals.<br />
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Button asChild className="px-6 bg-brand-blue text-white hover:bg-brand-blue/90 neon-shadow-blue">
            <Link href="mailto:support@vibe.virginia">Contact Support</Link>
          </Button>
